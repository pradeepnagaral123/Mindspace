        ...
        {moodOptions.map((option) => {
          ...
          return (
            <button
              ...
              className={`group flex w-full flex-col items-center justify-center gap-1.5 rounded-2xl py-1.5 transition-all sm:py-2 ${
            ...
            >
              ...
              <span
                className={`text-center text-[10px] leading-tight font-semibold transition-colors sm:text-[12px] ${
